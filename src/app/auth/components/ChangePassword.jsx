    ...
    return (
        <div class="flex flex-col items-center justify-center">
            ...
            <div class="relative text-gray-600 focus-within:text-gray-400">
                ...
                <input style={{ border: 'none' }} type="search" name="q" class="py-2 text-sm rounded-md pl-10 focus:text-gray-900" placeholder="Contraseña nueva" autocomplete="off" />
            </div>
            {/* E-mail */}
            <div class="relative text-gray-600 focus-within:text-gray-400 mt-2">
                ...
                <input style={{ border: 'none' }} type="search" name="q" class="py-2 text-sm rounded-md pl-10 focus:text-gray-900" placeholder="Repetir contraseña" autocomplete="off" />
            </div>
            {/* info */}
